        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(title) && !TextUtils.isEmpty(content)) {
                    ...
                    Snackbar.make(view, "Preencha os campos vazios", Snackbar.LENGTH_SHORT).show();
                }
                        ...
                        newNoteRef.setValue(noteMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(NewNoteActivity.this, "Nota adicionada no Banco de Dados", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(NewNoteActivity.this, "ERRO: tente novamente", Toast.LENGTH_SHORT).show();
                                }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.new_note_delete_btn:
                if (isExist) {
                    ...
                    Toast.makeText(this, "Deletando nota", Toast.LENGTH_SHORT).show();
                }
                break;
        }
