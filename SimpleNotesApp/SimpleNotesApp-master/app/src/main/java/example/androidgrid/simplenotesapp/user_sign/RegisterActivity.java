...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void registerUser(final String name, String email, String password){
        ...
        progressDialog.setMessage("Processando seu requerimento, aguarde um instante...");
        ...
        fAuth.createUserWithEmailAndPassword(email, password)
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    fUsersDatabase.child(fAuth.getCurrentUser().getUid())
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                finish();
                                Toast.makeText(RegisterActivity.this, "Usuáio criado!", Toast.LENGTH_SHORT).show();

                            } else {
                                progressDialog.dismiss();
                                Toast.makeText(RegisterActivity.this, "ERRO : Usuário não criado, tente novamente" , Toast.LENGTH_SHORT).show();
                            }
                    ...
                    Toast.makeText(RegisterActivity.this, "ERRO : tente novamente", Toast.LENGTH_SHORT).show();
